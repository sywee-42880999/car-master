...
# Publish only crops that passed visual QA in this Chat review.
approved = ["0011","0012","0013","0014","0015","0016","0019","0020"]
parts = ROOT / "images" / "parts"
parts.mkdir(exist_ok=True)
for id_ in approved:
    src = OUT / f"{id_}.jpg"
    if src.exists():
        (parts / f"{id_}.jpg").write_bytes(src.read_bytes())

result = """# CAR MASTER — 0011–0020 Production Correction Result
...
"""
(ROOT / "research" / "0011-0020-production-result.md").write_text(result, encoding="utf-8")
